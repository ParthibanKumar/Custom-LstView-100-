package com.example.saran.lstview;
...
{  /* Context context;
    ...
    CustomAdapter(Context c, String[] titlesection , String[] imgs, String[] desc)
    {
        super(c,R.layout.single_row,R.id.textView,titlesection);
        this.context=c;
        this.imagesets=imgs;
